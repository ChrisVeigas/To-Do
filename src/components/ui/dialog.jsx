    ...
    <DialogPortal>
      ...
      <DialogPrimitive.Content
        ...
        className={cn(
          ...
          "border rounded-xl p-6 shadow-xl duration-200",
          // Background & text (light/dark)
      ...
      >
        ...
        {/* Default hidden description for accessibility (prevents missing aria-describedby warnings) */}
        <DialogPrimitive.Description className="sr-only">
          This is a modal dialog. Interact with its content and close when done.
